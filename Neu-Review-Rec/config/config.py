...
class Tools_and_Home_Improvement_data_Config(DefaultConfig):

    def __init__(self):
        self.set_path('Tools_and_Home_Improvement_data')
    ...
    train_data_size = 107585
    test_data_size = 13445
    val_data_size = 13446
...
class Toys_and_Games_data_Config(DefaultConfig):
    ...
    train_data_size = 134103
    test_data_size = 16747
    val_data_size = 16747
...
class Baby_data_Config(DefaultConfig):
    ...
    train_data_size = 128638
    test_data_size = 16077
    val_data_size = 16077
